...
| :----- | :----- | :----- | :----- | :----- |
| AIS_SelectionScheme_Replace | @figure{visualization_selection_scheme_replace.jpg, ""}</td> |  | AIS_SelectionScheme_XOR | @figure{visualization_selection_scheme_XOR.jpg, ""}</td> |
| AIS_SelectionScheme_Add | @figure{visualization_selection_scheme_add.jpg, ""}</td> |  | AIS_SelectionScheme_Clear | @figure{visualization_selection_scheme_clear.jpg, ""}</td> |
| AIS_SelectionScheme_Remove | @figure{visualization_selection_scheme_remove.jpg, ""}</td> |  |  |  |
