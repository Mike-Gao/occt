...
public:
  ...
  //! Convert linear RGB component into sRGB using OpenGL specs formula, also known as gamma correction.
  ...
  //! Convert sRGB component into linear RGB using OpenGL specs formula, also known as gamma correction.
  ...
  static NCollection_Vec3<float> Convert_LinearRGB_To_sRGB (const NCollection_Vec3<float>& theRGB)
  {
    return NCollection_Vec3<float> (Convert_LinearRGB_To_sRGB (theRGB.r()),
  ...
  static NCollection_Vec3<float> Convert_sRGB_To_LinearRGB (const NCollection_Vec3<float>& theRGB)
  {
    return NCollection_Vec3<float> (Convert_sRGB_To_LinearRGB (theRGB.r()),
