...
public:
  ...
  Standard_EXPORT static TCollection_AsciiString StringFormatVersion();

public:

  static const XmlLDrivers_FormatVersion THE_CURRENT_VERSION = XmlLDrivers_FormatVersion::VERSION_10;
};
