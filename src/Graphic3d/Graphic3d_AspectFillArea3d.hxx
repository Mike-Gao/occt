...
public:
  ...
  //! Returns TRUE if elements should be drawn with filled interior.
  bool IsFilledInterior() const
  {
    return myInteriorStyle == Aspect_IS_SOLID
        || myInteriorStyle == Aspect_IS_SOLID_WIREFRAME
        || myInteriorStyle == Aspect_IS_HIDDENLINE;
  }

  //! Returns true if edges should be drawn (false by default).
  //! Alias for InteriorStyle()==Aspect_IS_SOLID_WIREFRAME.
  bool ToDrawEdges() const
  {
    return myInteriorStyle == Aspect_IS_SOLID_WIREFRAME
        || myInteriorStyle == Aspect_IS_HOLLOW
        || myInteriorStyle == Aspect_IS_HIDDENLINE;
  }

  //! Set if edges should be drawn or not.
  //! Alias for SetInteriorStyle() with Aspect_IS_SOLID_WIREFRAME or Aspect_IS_SOLID value.
  void SetDrawEdges (bool theToDraw)
  {
    myInteriorStyle = theToDraw ? Aspect_IS_SOLID_WIREFRAME : Aspect_IS_SOLID;
  }
  ...
  //! Alias for SetInteriorStyle(Aspect_IS_SOLID_WIREFRAME).
  void SetEdgeOn() { SetDrawEdges (true); }

  //! The edges of FillAreas are not drawn.
  //! Alias for SetInteriorStyle(Aspect_IS_SOLID).
  ...
  //! Returns TRUE if Interior Styles drawing element edges should discard first edge in triangle; FALSE by default.
