...
{
public:
  virtual int testMethod3 (int* theIntPtr, bool theToPrintStack) = 0;
};
...
public:
  MyTestClass() {}
  virtual int testMethod3 (int* theIntPtr, bool theToPrintStack)
  {
    if (theToPrintStack)
    {
      char aMsg[4096] = {};
      Standard_Failure::BacktraceCat (aMsg, 4096, 10);
      std::cout << aMsg << "\n";
      return 0;
    }
    *theIntPtr = 4;
...
static int myTestFunction2 (int* theIntPtr, bool theToPrintStack)
{
  Handle(MyTestInterface) aTest = new MyTestClass();
  return aTest->testMethod3 (theIntPtr, theToPrintStack);
}

static void myTestFunction1 (bool theToPrintStack)
{
  int* anIntPtr = NULL;
  myTestFunction2 (anIntPtr, theToPrintStack);
}

static Standard_Integer OCC30762 (Draw_Interpretor& theDI,
