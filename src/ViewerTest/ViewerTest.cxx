                                  ...
                                  const char**      theArgVec)
{
  ...
  for (; anArgIter < theArgNb; ++anArgIter)
  {
    ...
    else if (anArg == "-setlinetype")
    {
      ...
      if (!ViewerTest::ParseLineType (theArgVec[anArgIter], aChangeSet->StippleLinePattern))
      {
        std::cout << "Error: wrong syntax at " << anArg << "\n";
        return 1;
      }
  ...
  if (isDefaults)
  {
    ...
    {
      aDrawer->LineAspect()->Aspects()->SetLinePattern           (aChangeSet->StippleLinePattern);
      aDrawer->WireAspect()->Aspects()->SetLinePattern           (aChangeSet->StippleLinePattern);
      aDrawer->FreeBoundaryAspect()->Aspects()->SetLinePattern   (aChangeSet->StippleLinePattern);
      aDrawer->UnFreeBoundaryAspect()->Aspects()->SetLinePattern (aChangeSet->StippleLinePattern);
      aDrawer->SeenLineAspect()->Aspects()->SetLinePattern       (aChangeSet->StippleLinePattern);
    }
