                         ...
                         XmlObjMgt_RRelocationTable&  theRelocTable) const
{
  ...
  aNgName.Index(aNb);
//
  if(theRelocTable.GetHeaderData()->XmlStorageVersion() >= XML_LDRIVERS_VERSION_4) {
    ...
    if(theRelocTable.GetHeaderData()->XmlStorageVersion() >= XML_LDRIVERS_VERSION_5 &&
      theRelocTable.GetHeaderData()->XmlStorageVersion() < XML_LDRIVERS_VERSION_7) {
    ...
    if(theRelocTable.GetHeaderData()->XmlStorageVersion() >= XML_LDRIVERS_VERSION_7) {
