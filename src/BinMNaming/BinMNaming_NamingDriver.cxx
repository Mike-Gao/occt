...
//5. Index
      ...
      if(theRelocTable.GetHeaderData()->BinStorageVersion() >= BinLDrivers_FormatVersion::VERSION_4) 
      {
        ...
        if(theRelocTable.GetHeaderData()->BinStorageVersion() >= BinLDrivers_FormatVersion::VERSION_5 &&
            theRelocTable.GetHeaderData()->BinStorageVersion() < BinLDrivers_FormatVersion::VERSION_7)
        {
        ...
        if(theRelocTable.GetHeaderData()->BinStorageVersion() >= BinLDrivers_FormatVersion::VERSION_7)
        {
          ok = theSource >> anIndx;
