...
public:
  ...
  //! Return default material definition to be used for nodes without own style.
  const XCAFPrs_Style& DefaultStyle() const { return myDefaultStyle; }

  //! Set default material definition to be used for nodes without own style.
...
protected:
  ...
  XCAFPrs_Style           myDefaultStyle;      //!< default material definition to be used for nodes without own style
