...
public:
  ...
  {
    return BindFaceProgram (theTextures, theShadingModel, theAlphaMode, Aspect_IS_SOLID, theHasVertColor, theEnableEnvMap, theCustomProgram);
  }
                                    ...
                                    const Handle(OpenGl_ShaderProgram)& theCustomProgram)
  {
    ...
    const Standard_Integer aBits = getProgramBits (theTextures, theAlphaMode, theInteriorStyle, theHasVertColor, theEnableEnvMap);
                                    ...
                                    const Handle(OpenGl_ShaderProgram)& theCustomProgram)
  {
    ...
    Standard_Integer aBits = getProgramBits (theTextures, theAlphaMode, Aspect_IS_SOLID, theHasVertColor, false);
                                      ...
                                      const Handle(OpenGl_ShaderProgram)& theCustomProgram)
  {
    ...
    const Standard_Integer        aBits    = getProgramBits (theTextures, theAlphaMode, Aspect_IS_SOLID, theHasVertColor, false) | OpenGl_PO_Point;
    Handle(OpenGl_ShaderProgram)& aProgram = getStdProgram (theShadingModel, aBits);
    return bindProgramWithState (aProgram);
  }
...
protected:
  ...
  Standard_Integer getProgramBits (const Handle(OpenGl_TextureSet)& theTextures,
                                   ...
                                   Aspect_InteriorStyle theInteriorStyle,
                                   Standard_Boolean theHasVertColor,
                                   Standard_Boolean theEnableEnvMap) const
  {
    Standard_Integer aBits = 0;
    ...
    if (myContext->hasGeometryStage != OpenGl_FeatureNotAvailable
     && (theInteriorStyle == Aspect_IS_HIDDENLINE
      || theInteriorStyle == Aspect_IS_SOLID_WIREFRAME
      || theInteriorStyle == Aspect_IS_HOLLOW))
    {
      aBits |= OpenGl_PO_HollowMode;
